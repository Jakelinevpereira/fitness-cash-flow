...
import { LayoutDashboard, Package, ShoppingCart, Receipt, Wallet, LogOut, Loader2, Boxes, PiggyBank } from "lucide-react";
...
const nav = [
  ...
  { to: "/retiradas", label: "Retiradas", icon: PiggyBank },
] as const;
